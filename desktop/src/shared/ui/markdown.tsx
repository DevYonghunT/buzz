...
import { isEntityLink, parseEntityLink } from "@/shared/lib/entityLink";
...
export function createMarkdownComponents(
  ...
  function MarkdownAnchor({
    ...
    // Current and legacy entity links navigate in-app;
    ...
    if (href) {
      ...
      if (
        ...
        isEntityLink(parseSupportedLinkPreview(href, relayOrigin)?.href)
      )
        return entityAnchor;
    }
