...
test("parseSupportedLinkPreview parses Buzz relay git clone URLs", () => {
  ...
  assert.deepEqual(
    ...
    ),
    {
      ...
      href: `schoolx://repo?owner=${BUZZ_OWNER}&d=buzz-world-galaxy`,
      provider: "SchoolX",
...
test("parseSupportedLinkPreview strips .git suffix from clone URLs", () => {
  assert.deepEqual(
    ...
    {
      kind: "buzz-repository",
      href: `schoolx://repo?owner=${BUZZ_OWNER}&d=buzz-world`,
      provider: "SchoolX",
      title: "buzz-world",
      typeLabel: "repo",
    },
...
test("parseSupportedLinkPreview canonicalizes legacy entity links", () => {
  assert.deepEqual(
    parseSupportedLinkPreview(
    ...
    ),
    {
      ...
      href: `schoolx://pr?id=${BUZZ_EVENT_ID}&owner=${BUZZ_OWNER}&d=buzz-world`,
      provider: "SchoolX",
...
test("parseSupportedLinkPreview parses current project deep links", () => {
  assert.deepEqual(
    parseSupportedLinkPreview(
      `schoolx://project?owner=${BUZZ_OWNER}&d=buzz-world`,
    ),
    {
      kind: "buzz-project",
      href: `schoolx://project?owner=${BUZZ_OWNER}&d=buzz-world`,
      provider: "SchoolX",
      title: "buzz-world",
      typeLabel: "project",
    },
...
test("extractSupportedLinkPreviews excludes Buzz entity links while keeping external links", () => {
  const entityLinks = [
    `schoolx://repo?owner=${BUZZ_OWNER}&d=buzz-world`,
    `schoolx://pr?id=${BUZZ_EVENT_ID}&owner=${BUZZ_OWNER}&d=buzz-world`,
