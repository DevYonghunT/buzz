...
const APPEARANCE_MODE_OPTIONS = [
  {
    ...
    labelKey: "appearance.mode.system" as const,
    Icon: SunMoon,
  },
  {
    mode: "light" as const,
    labelKey: "appearance.mode.light" as const,
    Icon: Sun,
  },
  {
    mode: "dark" as const,
    labelKey: "appearance.mode.dark" as const,
    Icon: Moon,
  },
] as const;
    ...
    >
      ...
      <div className="relative">
        ...
        {/* Bottom fade — hidden while the accent picker is visible so its
            near-white gradient (SchoolX light) can't mask the swatches below it
        ...
        >
          <SettingsOptionRow data-testid="appearance-color-mode-row">
            ...
            <SegmentedControl
              ...
              options={APPEARANCE_MODE_OPTIONS.map(
                ({ mode, labelKey, Icon }) => ({
                  value: mode,
                  label: t(labelKey),
                  Icon,
          ...
          <SettingsOptionRow data-testid="theme-style-row">
            <div className="min-w-0">
              ...
              <p
                ...
                data-settings-subcopy
              >
                Choose the colors used throughout SchoolX.
              </p>
            </div>
            <button
