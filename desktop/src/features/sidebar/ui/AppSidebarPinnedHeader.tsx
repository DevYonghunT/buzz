        ...
        <SidebarMenu className="sidebar-primary-menu pb-2">
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              tooltip={t("app.sidebar.nav.inbox")}
              type="button"
            >
          ...
          <FeatureGate feature="pulse">
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip={t("app.sidebar.nav.pulse")}
                type="button"
              >
                <Activity className="h-4 w-4" />
                <SidebarMenuLabel>
                  {t("app.sidebar.nav.pulse")}
                </SidebarMenuLabel>
              </SidebarMenuButton>
            </SidebarMenuItem>
          </FeatureGate>
          <FeatureGate feature="projects">
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip={t("app.sidebar.nav.projects")}
                type="button"
              >
          ...
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              tooltip={t("app.sidebar.nav.agents")}
              type="button"
            >
          ...
          <FeatureGate feature="workflows">
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip={t("app.sidebar.nav.workflows")}
                type="button"
              >
