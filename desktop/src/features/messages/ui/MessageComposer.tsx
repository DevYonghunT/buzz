...
function MessageComposerImpl({
  ...
  React.useEffect(() => {
    if (!audienceScope || !audienceContext?.initialAgentPubkeys) return;
    persistentAudience.initialize(audienceContext.initialAgentPubkeys);
  }, [
    audienceContext?.initialAgentPubkeys,
    audienceScope,
    persistentAudience.initialize,
  ]);
