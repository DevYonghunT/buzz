...
export function MachineOnboardingFlow({
  ...
  }, [afterIdentityPage, continueWithRecoveredIdentity, queryClient]);
          ...
          {page === "identity" ? (
              ...
              >
                ...
                <div className="mt-5 max-w-[440px] text-sm leading-6 text-foreground/80">
                  {keyImportStage === "backup-password" ? (
                    ...
                    <p>
                      Paste your private key to sign in to SchoolX. You can also
                      use a{" "}
                      <button
                ...
                >
                  <div className="mx-auto w-full max-w-[35rem] pb-6 pt-10 text-center max-sm:pb-4 max-sm:pt-6">
                    ...
                    <DialogDescription className="mx-auto mt-4 max-w-[28rem] text-sm leading-6 text-foreground/80">
                      Choose the encrypted backup file you saved from SchoolX.
                    </DialogDescription>
                    <NostrKeyImportForm
                      footerMode="inline"
                      mode="backup"
            ...
            backupSubview === "password" ? (
              ...
              <BackupStep
                ...
                onNext={() => {
                  setTransitionDirection("forward");
                  afterIdentityPage(selectedPubkey ?? undefined);
                }}
