...
mod tests {
    ...
    fn metadata_prefers_open_graph_and_reads_site_name() {
        const EXTERNAL_SITE_NAME: &str = "Buzz"; // schoolx:buzz-name-ok
        let html = format!(
            r#"<meta content="{EXTERNAL_SITE_NAME}" property="og:site_name">
        ...
        assert_eq!(
            ...
            Some(LinkPreviewMetadata {
                ...
                site_name: Some(EXTERNAL_SITE_NAME.to_string()),
