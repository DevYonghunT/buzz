...
"$repo_root/scripts/test-code-git-xpc-packaging-contract.sh"
"$repo_root/scripts/test-schoolx-team-dmg-signing-contract.sh"
node --test "$repo_root/desktop/scripts/build-release-config.test.mjs"
"$repo_root/scripts/test-tauri-appimage-tools.sh"
