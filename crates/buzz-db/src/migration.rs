...
mod tests {
    ...
    fn embedded_migrator_contains_consolidated_initial_schema() {
        ...
        assert_eq!(migrations[32].version, 9001);
        let agent_add_policy = migrations[32].sql.as_str();
    ...
    async fn pre_0007_ambiguous_nip_rs_data_blocks_without_mutation_and_allows_retry() {
        ...
        // Derive the terminal version so this remains correct as upstream adds
        // migrations below SchoolX's reserved `9001+` range.
